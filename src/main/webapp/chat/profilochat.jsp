	...
	<div class="page-content">
		...
		<div class="fixed-sidebar" id="fixed">
			...
			<div id="schedaprofilo">
				<h4>Riepilogo match con:</h4>
				<%@include file="/common/profilobar.jsp"%>

				<!-- BOTTONI -->
				<div class="form-row">
					<div class="form-group col-md-6">
						<a href="/"><img id="accetta" title="Torna alla home"
							src="/foto/accetta.png"></a>
					</div>

					<div class="form-group col-md-6">
						<a href="/chat/rifiuta?profilo=<%= p.getId() %>">
						<img id="rifiuta" title="Disattiva il match" src="/foto/rifiuta.png"></a>
					</div>
