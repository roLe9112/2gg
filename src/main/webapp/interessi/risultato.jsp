...
<% List<Interessi> ints = (List<Interessi>) request.getAttribute("listainteressi"); %>
				...
				<div class="nofixed-sidebar" id="nofixed">
					<div class="nofixed-sidebar-content">
						...
						<div class="nofixed-sidebar-content">
							...
							<%	for(Interessi i : ints)
											{%>
							<form action="/interessi/aggiungi" method="get">
								<!-- Stampiamo tutti i dettagli della Videogioco -->
								-->
								<%= i.getInteresse() %>
								
								<input type="text" name="idinteresse" value="<%= i.getId() %>">
